<template>
  <div class="el-input">
    <input :value="value" class="el-input__inner" ref="input" @keydown="keyDown" @keypress="keyPress" @keyup="keyUp" @textInput="textInput" @mouseup="mouseUp" @focusout="focusOut" @cut="cut" @copy="copy" @paste="paste"/>
  </div>
</template>
<script>import InputMask from 'inputmask-core';
