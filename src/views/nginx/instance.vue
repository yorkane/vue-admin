<template>
  <div class="mainPanel">
    ...
    <div style="overflow: auto;">
      ...
      <instance-grid :dataStruct="m_dataStruct" :model="gridData" :totalCount="totalCount"
...
<script>
  ...
  import mform from "../../model/form.vue";
  ...
  export default {
    ...
    mixins: [KDataStruct],
    data: function () {
      this._api = modelAPI.new('nginx_instance', {
        status: '1,2,3,-1,-2,-3'
      }, this.$store)
      return {
        isEditMode: true,
    ...
    methods: {
      ...
      getData: function (where, orderby) {
        ...
        //console.log(query)
        this._api.getData(query, store, true).then(data => {
          this.dataList = data
